...
- [ ] Create methodologies/spec_driven.py
  _US-1: Spec-Driven Methodology_
...
- [ ] Create methodologies/_template.py with full example
  _US-8: Methodology Extensibility_
