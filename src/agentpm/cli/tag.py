...
from agentpm.cli.formatting import console, create_tags_table, short_id
...
def list_tags():
    """List all tags."""
    from agentpm.core import list_tags as _list_tags
...
def create_tag(
    ...
    """Create a new tag."""
    from agentpm.core import create_tag as _create_tag
...
def list_nodes_by_tag(
    ...
    from agentpm.core import list_nodes_by_tag as _list_nodes_by_tag
    from agentpm.cli.formatting import create_nodes_table
