...
def show_project(
    ...
    from agentpm.core import get_project, get_project_stats, list_milestones
...
def update_project(
    ...
    """Update a project."""
    from agentpm.core import update_project as _update_project
...
def delete_project(
    ...
    """Delete a project."""
    from agentpm.core import get_project, delete_project as _delete_project
