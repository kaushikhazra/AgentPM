...
from agentpm.cli.formatting import console, create_nodes_table, format_duration, short_id
...
def create_task(
    ...
    from agentpm.core import create_task as _create_task
...
def unblock_task(
    ...
    """Unblock a task."""
    from agentpm.core import unblock_node
