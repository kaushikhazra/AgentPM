...
mcp = FastMCP("agentpm", instructions="""
AgentPM is an AI-first project management system.
...
def pm_update_project(
    ...
    """
    from agentpm.core import update_project
...
def pm_list_milestones(
    ...
    """
    from agentpm.core import list_milestones
...
def pm_complete_milestone(milestone_id: str) -> dict:
    ...
    """
    from agentpm.core import complete_milestone
...
def pm_create_node(
    ...
    """
    from agentpm.graph import create_node, create_edge
    node = create_node(
        project_id=project_id,
        node_type=node_type,
        title=title,
...
def pm_get_node(node_id: str) -> dict:
    ...
    """
    from agentpm.graph import get_node, list_edges
    from agentpm.core import list_time_entries, get_node_rollup
...
def pm_block_node(node_id: str, reason: str) -> dict:
    ...
    Returns:
        The updated node object
    """
    from agentpm.core import block_node
...
def pm_create_edge(
    ...
    """
    from agentpm.graph import create_edge
    edge = create_edge(
        source_id=source_id,
        target_id=target_id,
        edge_type=edge_type,
...
def pm_delete_edge(edge_id: str) -> bool:
    ...
    Returns:
        True if deleted
    """
    from agentpm.graph import delete_edge
...
def pm_get_ancestors(node_id: str, edge_type: str | None = None) -> list[dict]:
    ...
    """
    from agentpm.graph import get_ancestors
...
def pm_get_descendants(node_id: str, edge_type: str | None = None) -> list[dict]:
    ...
    """
    from agentpm.graph import get_descendants
...
def pm_log_time(
    ...
    """
    from agentpm.core import log_time
...
def pm_get_project_stats(project_id: str) -> dict:
    ...
    Returns:
        Project statistics
    """
    from agentpm.core import get_project_stats
    stats = get_project_stats(project_id)
...
def pm_get_rollup(node_id: str) -> dict:
    ...
    Returns:
        Rollup statistics
    """
    from agentpm.core import get_node_rollup
    rollup = get_node_rollup(node_id)
    return {
        "total_time_minutes": rollup.total_time_minutes,
        "estimated_time_minutes": rollup.estimated_time_minutes,
...
def pm_list_tags() -> list[dict]:
    ...
    Returns:
        List of tag objects
    """
    from agentpm.core import list_tags
    tags = list_tags()
...
def pm_create_tag(name: str, color: str | None = None) -> dict:
    ...
    """
    from agentpm.core import create_tag
...
def pm_tag_node(node_id: str, tag_name: str) -> bool:
    ...
    """
    from agentpm.core import tag_node
...
def pm_untag_node(node_id: str, tag_name: str) -> bool:
    ...
    """
    from agentpm.core import untag_node
