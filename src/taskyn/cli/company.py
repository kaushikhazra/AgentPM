...
from taskyn.cli.formatting import console, create_companies_table, short_id, format_date
...
def list_companies():
    """List all companies."""
    from taskyn.core import list_companies as _list_companies
...
def create_company(
    ...
    from taskyn.core import create_company as _create_company
...
def delete_company(
    ...
    """Delete a company."""
    from taskyn.core import get_company, delete_company as _delete_company
