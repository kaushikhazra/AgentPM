...
from taskyn.exceptions import TaskynError, NotFoundError, ValidationError

app = typer.Typer(
    name="taskyn",
    help="Taskyn - AI-first Project Management",
...
def main(
    ...
    """Taskyn - AI-first Project Management CLI"""
    state.db_path = db
    state.json_output = json_output
    state.verbose = verbose

    if db:
        from taskyn.db.connection import set_database_path
